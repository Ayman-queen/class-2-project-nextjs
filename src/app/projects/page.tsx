    ...
    <div>
      <Header />
        <div className="bg-white bg-opacity-80 p-10 rounded-lg">
          <h1 className="text-4xl font-extrabold text-gray-800 mb-4">Projects</h1>
          <p className="text-gray-600 leading-relaxed mb-8">
            Welcome to my projects page! Here you'll find some of the projects I’ve worked on. Feel free to explore!
          </p>
